...
public class Ex2_7_5 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(readed.charAt(0));
        System.out.println(readed.charAt(1));
        System.out.println(readed.charAt(2));
        System.out.println(readed.charAt(3));
